...
namespace CoreDb
{
    ...
    internal class LinqHelper
    {
        ...
        public static Setter_t<T> GetSetter<T>(string fieldName)
        {
            ...
            System.Reflection.FieldInfo fi = System.Reflection.IntrospectionExtensions.GetTypeInfo(t)
            ...
            System.Reflection.PropertyInfo pi = System.Reflection.IntrospectionExtensions.GetTypeInfo(t)
